...
FWF_tiles_lookup:
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4) ;$00
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4) ;$10
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((BLANK_tile - FWF_tiles_data) >> 4) ;$20
    DB LOW((EXCLAMATION_tile - FWF_tiles_data) >> 4)
    DB LOW((QUOTE_tile - FWF_tiles_data) >> 4)
    DB LOW((HASHTAG_tile - FWF_tiles_data) >> 4)
    DB LOW((DOLLAR_tile - FWF_tiles_data) >> 4)
    DB LOW((PERCENT_tile - FWF_tiles_data) >> 4)
    DB LOW((AMPERSTAND_tile - FWF_tiles_data) >> 4)
    DB LOW((APOSTROPHE_tile - FWF_tiles_data) >> 4)
    DB LOW((OPARENTH_tile - FWF_tiles_data) >> 4)
    DB LOW((CPARENTH_tile - FWF_tiles_data) >> 4)
    DB LOW((STAR_tile - FWF_tiles_data) >> 4)
    DB LOW((PLUS_tile - FWF_tiles_data) >> 4)
    DB LOW((COMMA_tile - FWF_tiles_data) >> 4)
    DB LOW((MINUS_tile - FWF_tiles_data) >> 4)
    DB LOW((DOT_tile - FWF_tiles_data) >> 4)
    DB LOW((SLASH_tile - FWF_tiles_data) >> 4)
    DB LOW((ZERO_tile - FWF_tiles_data) >> 4) ;$30
    DB LOW((ONE_tile - FWF_tiles_data) >> 4)
    DB LOW((TWO_tile - FWF_tiles_data) >> 4)
    DB LOW((THREE_tile - FWF_tiles_data) >> 4)
    DB LOW((FOUR_tile - FWF_tiles_data) >> 4)
    DB LOW((FIVE_tile - FWF_tiles_data) >> 4)
    DB LOW((SIX_tile - FWF_tiles_data) >> 4)
    DB LOW((SEVEN_tile - FWF_tiles_data) >> 4)
    DB LOW((EIGHT_tile - FWF_tiles_data) >> 4)
    DB LOW((NINE_tile - FWF_tiles_data) >> 4)
    DB LOW((COLON_tile - FWF_tiles_data) >> 4)
    DB LOW((SCOLON_tile - FWF_tiles_data) >> 4)
    DB LOW((LESSER_tile - FWF_tiles_data) >> 4)
    DB LOW((EQUAL_tile - FWF_tiles_data) >> 4)
    DB LOW((GREATER_tile - FWF_tiles_data) >> 4)
    DB LOW((QUESTION_tile - FWF_tiles_data) >> 4)
    DB LOW((AROBASE_tile - FWF_tiles_data) >> 4) ;$40
    DB LOW((A_tile - FWF_tiles_data) >> 4)
    DB LOW((B_tile - FWF_tiles_data) >> 4)
    DB LOW((C_tile - FWF_tiles_data) >> 4)
    DB LOW((D_tile - FWF_tiles_data) >> 4)
    DB LOW((E_tile - FWF_tiles_data) >> 4)
    DB LOW((F_tile - FWF_tiles_data) >> 4)
    DB LOW((G_tile - FWF_tiles_data) >> 4)
    DB LOW((H_tile - FWF_tiles_data) >> 4)
    DB LOW((I_tile - FWF_tiles_data) >> 4)
    DB LOW((J_tile - FWF_tiles_data) >> 4)
    DB LOW((K_tile - FWF_tiles_data) >> 4)
    DB LOW((L_tile - FWF_tiles_data) >> 4)
    DB LOW((M_tile - FWF_tiles_data) >> 4)
    DB LOW((N_tile - FWF_tiles_data) >> 4)
    DB LOW((O_tile - FWF_tiles_data) >> 4)
    DB LOW((P_tile - FWF_tiles_data) >> 4) ;$50
    DB LOW((Q_tile - FWF_tiles_data) >> 4)
    DB LOW((R_tile - FWF_tiles_data) >> 4)
    DB LOW((S_tile - FWF_tiles_data) >> 4)
    DB LOW((T_tile - FWF_tiles_data) >> 4)
    DB LOW((U_tile - FWF_tiles_data) >> 4)
    DB LOW((V_tile - FWF_tiles_data) >> 4)
    DB LOW((W_tile - FWF_tiles_data) >> 4)
    DB LOW((X_tile - FWF_tiles_data) >> 4)
    DB LOW((Y_tile - FWF_tiles_data) >> 4)
    DB LOW((Z_tile - FWF_tiles_data) >> 4)
    DB LOW((OBRACKET_tile - FWF_tiles_data) >> 4)
    DB LOW((BACKSLASH_tile - FWF_tiles_data) >> 4)
    DB LOW((CBRACKET_tile - FWF_tiles_data) >> 4)
    DB LOW((CIRCUMFLEX_tile - FWF_tiles_data) >> 4)
    DB LOW((UNDERSCORE_tile - FWF_tiles_data) >> 4)
    DB LOW((BACK_APOSTROPHE_tile - FWF_tiles_data) >> 4) ;$60
    DB LOW((a_tile - FWF_tiles_data) >> 4)
    DB LOW((b_tile - FWF_tiles_data) >> 4)
    DB LOW((c_tile - FWF_tiles_data) >> 4)
    DB LOW((d_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((n_tile - FWF_tiles_data) >> 4)
    DB LOW((o_tile - FWF_tiles_data) >> 4)
    DB LOW((p_tile - FWF_tiles_data) >> 4) ;$70
    DB LOW((q_tile - FWF_tiles_data) >> 4)
    DB LOW((r_tile - FWF_tiles_data) >> 4)
    DB LOW((s_tile - FWF_tiles_data) >> 4)
    DB LOW((t_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((y_tile - FWF_tiles_data) >> 4)
    DB LOW((z_tile - FWF_tiles_data) >> 4)
    DB LOW((OCBRACKET_tile - FWF_tiles_data) >> 4)
    DB LOW((VBAR_tile - FWF_tiles_data) >> 4)
    DB LOW((CCBRACKET_tile - FWF_tiles_data) >> 4)
    DB LOW((TILDE_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((CCEDILLA_tile - FWF_tiles_data) >> 4) ;$80
    DB LOW((uTREM_tile - FWF_tiles_data) >> 4)
    DB LOW((eAIG_tile - FWF_tiles_data) >> 4)
    DB LOW((aCARET_tile - FWF_tiles_data) >> 4)
    DB LOW((aTREM_tile - FWF_tiles_data) >> 4)
    DB LOW((aGRAV_tile - FWF_tiles_data) >> 4)
    DB LOW((aRING_tile - FWF_tiles_data) >> 4)
    DB LOW((cCEDILLA_tile - FWF_tiles_data) >> 4)
    DB LOW((eCARET_tile - FWF_tiles_data) >> 4)
    DB LOW((eTREM_tile - FWF_tiles_data) >> 4)
    DB LOW((eGRAV_tile - FWF_tiles_data) >> 4)
    DB LOW((iTREM_tile - FWF_tiles_data) >> 4)
    DB LOW((iCARET_tile - FWF_tiles_data) >> 4)
    DB LOW((iGRAV_tile - FWF_tiles_data) >> 4)
    DB LOW((ATREM_tile - FWF_tiles_data) >> 4)
    DB LOW((ARING_tile - FWF_tiles_data) >> 4)
    DB LOW((EAIG_tile - FWF_tiles_data) >> 4) ;$90
    DB LOW((aeSYM_tile - FWF_tiles_data) >> 4)
    DB LOW((AESYM_tile - FWF_tiles_data) >> 4)
    DB LOW((oCARET_tile - FWF_tiles_data) >> 4)
    DB LOW((oTREM_tile - FWF_tiles_data) >> 4)
    DB LOW((oGRAV_tile - FWF_tiles_data) >> 4)
    DB LOW((uCARET_tile - FWF_tiles_data) >> 4)
    DB LOW((uGRAV_tile - FWF_tiles_data) >> 4)
    DB LOW((yTREM_tile - FWF_tiles_data) >> 4)
    DB LOW((OTREM_tile - FWF_tiles_data) >> 4)
    DB LOW((UTREM_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((aAIG_tile - FWF_tiles_data) >> 4) ;$A0
    DB LOW((iAIG_tile - FWF_tiles_data) >> 4)
    DB LOW((oAIG_tile - FWF_tiles_data) >> 4)
    DB LOW((uAIG_tile - FWF_tiles_data) >> 4)
    DB LOW((nTILDE_tile - FWF_tiles_data) >> 4)
    DB LOW((NTILDE_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((IQUESTION_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4) ;$B0
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4) ;$C0
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4) ;$D0
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4) ;$E0
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4) ;$F0
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    ...
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4)
    DB LOW((UNKNOWN_tile - FWF_tiles_data) >> 4) ;$FF
