...
sfx_data_4:
    DB %00101101, %00000111, $91, $AF, $C7, $80, $0A
sfx_data_5:
    DB %00111101, %00000111, $91, $AF, $C7, $80, $0A
sfx_data_6:
    DB %01001101, %00000111, $91, $AF, $C7, $80, $0A
sfx_data_7:
    DB %01011101, %00000111, $91, $AF, $C7, $80, $0A
sfx_data_8:
    DB %01101101, %00000111, $91, $AF, $C7, $80, $0A
sfx_data_9:
    DB %01111101, %00000111, $91, $AF, $C6, $80, $0A
sfx_data_10:
    DB %00011101, %00000111, $91, $AF, $C6, $F0, $0A
sfx_data_11:
    DB %00011101, %00000111, $F1, $AF, $C6, $FF, $0A
sfx_data_12:
    DB %00011101, %00000111, $F1, $AF, $C6, $FF, $0A
sfx_data_13:
    DB %00011101, %00000111, $F1, $AF, $C6, $FF, $0A
